# -*- coding: utf-8 -*-
"""
Created on Mon Dec 10 22:31:24 2018
...
classifierANN.add(Dense(units = 12, kernel_initializer = 'uniform', activation = 'relu', input_dim = 23))
classifierANN.add(Dense(units = 12, kernel_initializer = 'uniform', activation = 'relu'))
